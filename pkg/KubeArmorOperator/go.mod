...
require (
	github.com/daemon1024/bpflsmprobe v0.0.0-20230724205136-8b744a822dbe
...
require (
	...
	github.com/kubearmor/KubeArmor/KubeArmor v0.0.0-20230626060245-4f5b8ac4f298 // indirect
